...
> 🚀 **本库正在接入线上平台 [metisziwei.com](https://metisziwei.com)** —— 我们正在加速天纪板块的开发，
> 让用户与倪海厦体系的学习者获得更好的交流与学习体验。**预计一周内上线，敬请期待。**

线上体验：[metisziwei.com](https://metisziwei.com)（排盘 / AI 解读 / 天纪知识库）
...
**天纪板块正在加速开发中**：把这 4886 条判语接成可检索、可回放、可与命盘联动的学习产品，
让用户与倪海厦体系的学习者获得更好的交流与学习体验。**预计一周内上线。**

| | |
|---|---|
| 排盘与 AI 解读 | 已上线 |
| 天纪判语库（本仓库数据） | 开发中，预计一周内 |
| 判语 ↔ 命盘联动（论到你的盘上） | 规划中 |

## 项目理念

**算法是公开的传统智慧，不应该被锁在围墙里。** 真正的价值在于解读的深度、
用户体验的打磨、以及持续运营的积累。
...
- [ziwei-doushu](https://github.com/Renhuai123/ziwei-doushu) —— 紫微斗数开源排盘引擎
  （排盘算法 + 51.8 万命盘样本）。本库是它的知识层：引擎算出盘，本库回答「倪师怎么论这个盘」。

## 版权与致谢

- 《天纪》课程内容著作权归**倪海厦先生及其权利继承人**所有。
- 本库判语引文的内容是**倪师的口述原话**。整理过程以 B 站公开视频为素材，
  经 OCR、双 ASR 引擎交叉核验与 171 处人工勘误得出；相关事宜已与视频上传者沟通并获知悉。
- 出处链接指向 B 站原视频页面，为读者提供回放核对入口，亦为原视频带来访问。
